...
function validateResponseProperties(x) {
    return Object.keys(x).filter(key => responsePropertyNames.indexOf(key) !== -1).length > 0;
}
...
module.exports = {
    ...
    installInto: function (expect) {
        ...
        expect.addAssertion('<any> to yield exchange <object>', function (expect, subject, value) {
            ...
            value = Object.assign({}, value);
            var requestProperties = typeof value.request === 'string' ? {url: value.request} : Object.assign({}, value.request),
